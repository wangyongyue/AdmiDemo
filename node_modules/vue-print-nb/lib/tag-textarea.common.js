...
function () {
  ...
  _createClass(_default, [{
    ...
    value: function print(PAWindow) {
      var iddd = document.getElementById(this.settings.id);
      var paWindow = PAWindow.win;
      var iframe = PAWindow.f;
    ...
    value: function getHead() {
      ...
      if (typeof_typeof(_links) === 'object' || _links.length > 0) {
        // 复制所有link标签
      ...
      for (var _i = 0; _i < document.styleSheets.length; _i++) {
        if (document.styleSheets[_i].cssRules || document.styleSheets[_i].rules) {
          var rules = document.styleSheets[_i].cssRules || document.styleSheets[_i].rules;
    ...
    value: function getFormData(ele) {
      ...
      for (var i = 0; i < copiedInputs.length; i++) {
        var item = copiedInputs[i];
        var typeInput = item.getAttribute('type');
        var copiedInput = copiedInputs[i]; // 获取select标签
        ...
        if (item.tagName === 'INPUT') {
          ...
          for (var b = 0; b < ele.querySelectorAll('select').length; b++) {
            var select = ele.querySelectorAll('select')[b]; // 获取原始层每一个select
...
/* harmony default export */ var packages_print = ({
  directiveName: 'print',
  bind: function bind(el, binding, vnode) {
    ...
    var localPrint = function localPrint() {
      vue.$nextTick(function () {
        if (closeBtn) {
          closeBtn = false;
          var print = new printarea_default({
            el: binding.value,
...
packages_print.install = function (Vue) {
  Vue.directive('print', packages_print);
};

/* harmony default export */ var src = (packages_print);
